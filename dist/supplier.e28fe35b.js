...
exports.Axios = Axios;
},{"./lib/axios.js":"node_modules/axios/lib/axios.js"}],"src/web/js/supplier.js":[function(require,module,exports) {
"use strict";
...
$("#btnCadastro").click(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
  var id, name, representative, email, address, telephone, website;
  return _regeneratorRuntime().wrap(function _callee$(_context) {
    while (1) switch (_context.prev = _context.next) {
      case 0:
        id = $("#txtId").val();
        name = $("#txtName").val();
        representative = $("#txtRepresentative").val();
        email = $("#txtEmail").val();
        ...
        _context.next = 10;
        return _axios.default.post(url + 'supplier', {
          name: name,
      ...
      case 12:
        _context.next = 14;
        return _axios.default.put(url + 'supplier/' + id, {
          name: name,
          representative: representative,
          email: email,
          address: address,
...
function loadTable() {
  _axios.default.get(url + 'supplier', {}).then(function (response) {
    var table = new DataTable('#tbSupplier', {
      data: response.data,
      columns: [{
        data: 'id'
      }, {
  ...
  _Excluir = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(id) {
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
          return _axios.default.delete(url + "supplier/" + id, {}).then(function (response) {
...
function loadSupplier(_x2) {
  return _loadSupplier.apply(this, arguments);
}
function _loadSupplier() {
  _loadSupplier = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(id) {
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _context4.next = 2;
          return _axios.default.get(url + 'supplier/' + id, {}).then(function (response) {
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/web/js/supplier.js"], null)
//# sourceMappingURL=/supplier.e28fe35b.js.map