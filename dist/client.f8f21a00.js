...
$("#btnCadastro").click(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
  var id, name, description, cpf, address, fone;
  return _regeneratorRuntime().wrap(function _callee$(_context) {
    while (1) switch (_context.prev = _context.next) {
      case 0:
        ...
        _context.next = 9;
        return _axios.default.post(url + 'client', {
          name: name,
      ...
      case 11:
        _context.next = 13;
        return _axios.default.put(url + 'client/' + id, {
          name: name,
          description: description,
          cpf: cpf,
          address: address,
...
function loadTable() {
  _axios.default.get(url + 'client', {}).then(function (response) {
    var table = new DataTable('#tbClient', {
      data: response.data,
      columns: [{
        data: 'id'
      }, {
  ...
  _Excluir = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(id) {
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
          return _axios.default.delete(url + "client/" + id, {}).then(function (response) {
...
function loadClient(_x2) {
  return _loadClient.apply(this, arguments);
}
function _loadClient() {
  _loadClient = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(id) {
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _context4.next = 2;
          return _axios.default.get(url + 'client/' + id, {}).then(function (response) {
