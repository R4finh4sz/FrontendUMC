...
$("#btnLogin").click(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
  var id, name, description, price, category;
  return _regeneratorRuntime().wrap(function _callee$(_context) {
    while (1) switch (_context.prev = _context.next) {
      case 0:
        ...
        price = $("#txtPrice").val();
        category = $("#ddICategory option:selected").val();
        if (id) {
          _context.next = 10;
          break;
        }
        _context.next = 8;
        return _axios.default.post(url + 'product', {
          name: name,
...
$(document).ready(function () {
  _axios.default.get(url + 'category', {}).then(function (response) {
    $.each(response.data, function (key, item) {
      $('#ddICategory').append($("<option></option>").attr("value", item.id).text(item.name));
    });
  }).catch(function (error) {
    alert(error);
  });
...
function loadTable() {
  _axios.default.get(url + 'product', {}).then(function (response) {
    var table = new DataTable('#tbProduct', {
      data: response.data,
      columns: [{
        data: 'id'
      }, {
  ...
  _Excluir = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(id) {
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
          return _axios.default.delete(url + "product/" + id, {}).then(function (response) {
...
function _loadProduct() {
  _loadProduct = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(id) {
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _context4.next = 2;
          return _axios.default.get(url + 'product/' + id, {}).then(function (response) {
