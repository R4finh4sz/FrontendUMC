...
'use strict';
var switchers = document.querySelectorAll('.btn, .btn2, .theme-switch__checkbox');
$("#btnLogin").click(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
  var id, user, product, quantity, client;
  return _regeneratorRuntime().wrap(function _callee$(_context) {
    while (1) switch (_context.prev = _context.next) {
      case 0:
        id = $("#txtId").val();
        user = $("#ddIUser option:selected").val();
        product = $("#ddIProduct option:selected").val();
        quantity = $("#txtQuantidade").val();
        client = $("#ddIClient option:selected").val();
        if (id) {
          _context.next = 10;
          break;
        }
        _context.next = 8;
        return _axios.default.post(url + 'sale', {
          user: {
            id: user
          },
          product: {
      ...
      case 10:
        _context.next = 12;
        return _axios.default.put(url + 'sale/' + id, {
          user: {
            id: user
          },
          product: {
...
$(document).ready(function () {
  _axios.default.get(url + 'product', {}).then(function (response) {
    $.each(response.data, function (key, item) {
      $('#ddIProduct').append($("<option></option>").attr("value", item.id).text(item.name));
    });
  });
  _axios.default.get(url + 'user', {}).then(function (response) {
    $.each(response.data, function (key, item) {
      $('#ddIUser').append($("<option></option>").attr("value", item.id).text(item.name));
    });
  });
  _axios.default.get(url + 'client', {}).then(function (response) {
    $.each(response.data, function (key, item) {
      $('#ddIClient').append($("<option></option>").attr("value", item.id).text(item.name));
    });
  }).catch(function (error) {
    alert(error);
  });
...
function loadTable() {
  _axios.default.get(url + 'sale', {}).then(function (response) {
    var table = new DataTable('#tbSale', {
      data: response.data,
      columns: [{
        data: 'id'
      }, {
...
function _Excluir() {
  _Excluir = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(id) {
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
          return _axios.default.delete(url + "sale/" + id, {}).then(function (response) {
...
function loadSale(_x2) {
  return _loadSale.apply(this, arguments);
}
function _loadSale() {
  _loadSale = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(id) {
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _context4.next = 2;
          return _axios.default.get(url + 'sale/' + id, {}).then(function (response) {
