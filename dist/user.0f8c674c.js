...
$("#btnLogin").click(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
  var id, name, email, admin, password, profile;
  return _regeneratorRuntime().wrap(function _callee$(_context) {
    while (1) switch (_context.prev = _context.next) {
      case 0:
        ...
        name = $("#txtName").val();
        email = $("#txtEmail").val();
        admin = $("#chkAdmin").prop('checked');
        password = $("#txtSenha").val();
        profile = $("#ddIProfile option:selected").val();
        if (id) {
          _context.next = 11;
          break;
        }
      ...
      case 11:
        _context.next = 13;
        return _axios.default.put(url + 'user/' + id, {
          name: name,
          email: email,
          admin: admin,
          password: password,
...
$(document).ready(function () {
  _axios.default.get(url + 'profiles', {}).then(function (response) {
    $.each(response.data, function (key, item) {
      $('#ddIProfile').append($("<option></option>").attr("value", item.id).text(item.name));
    });
  }).catch(function (error) {
    alert(error);
  });
...
function loadTable() {
  _axios.default.get(url + 'user', {}).then(function (response) {
    var table = new DataTable('#tbUsers', {
      data: response.data,
      columns: [{
        data: 'id'
      }, {
  ...
  _Excluir = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(id) {
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
          return _axios.default.delete(url + "user/" + id, {}).then(function (response) {
...
function _loadUser() {
  _loadUser = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(id) {
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _context4.next = 2;
          return _axios.default.get(url + 'user/' + id, {}).then(function (response) {
